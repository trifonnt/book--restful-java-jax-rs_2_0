...
@Transactional
public class ProductResourceBean implements IProductResource {
	...
	public Products getProducts(int start, int size, String name, UriInfo uriInfo) {
		UriBuilder builder = uriInfo.getAbsolutePathBuilder();
		...
		List<?> productEntities = query.setFirstResult(start).setMaxResults(size)
				.getResultList();
