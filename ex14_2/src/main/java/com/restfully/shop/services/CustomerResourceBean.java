...
@Transactional
public class CustomerResourceBean implements ICustomerResource {
	...
	public Customers getCustomers(int start, int size, String firstName, String lastName, UriInfo uriInfo) {
		UriBuilder builder = uriInfo.getAbsolutePathBuilder();
